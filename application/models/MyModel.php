<?php
    ...
    class MyModel extends CI_Model {
        ...
        public function add_rider($params)
        {
            ...
            {
                return array('status' => 401,'message' => 'Can not be empty');
            }
            else
            {
                ...
                if($api_key=="zhjeDX8SH3ryV0RGk8f3ZWRigkkm3qxBw")
                {
                    ...
                    {
                        return array('status' => 401,'message' => 'No Such any reference number Choose correct one');
                    }
                }
                else
                { 
                    return array('status' => 401,'message' => 'Something Went Wrong Please Try Again Later');
                }
            }   
        }
        ...
        public function send_rider_request($params)
        {
            ...
            {
                return array('status' => 401,'message' => 'Fields can not be empty');
            }
            else
            {
                ...
                if($api_key=="zhjeDX8SH3ryV0RGk8f3ZWRigkkm3qxBw")
                {
                    ...
                    if($isExists)
                    {
                        return array('status' => 401,'message' => 'You have already sent request');
                    }
                    else
                    {
                        $result = $this->db->insert('sab_seller_rider',array('rider_id' => $params['rider_id'],'store_id' => $params['store_id']));
                            ...
                            {
                               return array('status' => 401,'message' => 'Request sending fail! Please Try Again Later');
                            }
                    }
                }
                else
                {
                     return array('status' => 401,'message' => 'Something Went Wrong!');
                }
            }
        }
        ...
        public function rider_information($params)
        {
            if($params['rider_id'] == "")
            {
                return array('status' => 401,'message' => 'Field can not be empty');
            }
            else
            {
                $api_key   = $this->input->get_request_header('api_key', TRUE);
                ...
                if($api_key=="zhjeDX8SH3ryV0RGk8f3ZWRigkkm3qxBw")
                {
                    ...
                    {
                         return array('status' => 401,'message' => 'Rider Id Not Found');
                    }
                }
                else
                {
        ...
        public function cancel_rider_request($params)
        {
            ...
            else
            {
                ...
                if($api_key=="zhjeDX8SH3ryV0RGk8f3ZWRigkkm3qxBw")
                {
                    ...
                    {
                        return array('status' => 401,'message' => 'Request Fail ! Try agian Later');
                    }
                }
                else
                {
        ...
        public function rider_list($params)
        {
            if($params['store_id'] == "")
            {
                return array('status' => 401,'message' => 'Store Id can not be empty');
            }
            else
            {
                $api_key   = $this->input->get_request_header('api_key', TRUE);
                ...
                if($api_key=="zhjeDX8SH3ryV0RGk8f3ZWRigkkm3qxBw")
                {
                    ...
                    {
                        return array('status' => 401,'message' => 'Invalid Store Id');
                    }
                }
                else
                {
